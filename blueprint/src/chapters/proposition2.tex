...
\begin{proposition}
  ...
  $\boldsymbol{A}$ and $\boldsymbol{A'}[a\#b]$ respectively, and $h_2:A'''\rightarrow{A''}$ is a
  ring homomorphism extending $h$. If $(f,h_2)$ is a spring morphism from $\boldsymbol{A''}$ to
  $\boldsymbol{A'''}$, then $h(a)\#h(b)=h_2(a\#b)$, meaning that $h(a)\#h(b)$ belongs to $A''$.
\end{proposition}
\begin{proof}
\end{proof}
