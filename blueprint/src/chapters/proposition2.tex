...
\begin{proof}
  ...
  as $h_2(a\#b)h(b)=h_2(a\#b)h_2(b)=h_2(a)=h(a)=(h(a)\#h(b))h(b)$, we immediately have that
  $h_2(a\#b)(x)=(h(a)\#h(b))(x)$. If $h(b)(x)=0$, then $x\in{z}(h_2(b))$ and so $f(x)\in{z}(b)$ by
  Lemma \ref{memdhiff}. This means $(a\#b)(f(x))=0$. Then Lemma \ref{memdhiff} implies
  $h_2(a\#b)(x)=0$. Therefore, $h_2(a\#b)(x)=(h(a)\#h(b))(x)$.
\end{proof}
